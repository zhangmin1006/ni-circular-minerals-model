...
- **Verification harness** (`verify_model.py`): **53 checks** — *invariant*: MFA mass
  ...
  non-negative reserve. **All 53 pass.**
...
python verify_model.py                    # 53 invariant + property-based checks
