...
- **The benefits come at modest carbon cost.** Minviro's CLCA puts the most active mining scenario at only ~0.36% of NI annual CO2 (and ~0.24% of PM) — so the economic case is not bought with large national emissions (the real impact trade-off is the *local* environmental burden, Q2.7).
